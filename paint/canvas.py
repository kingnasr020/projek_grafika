...
class Canvas(QWidget):
    ...
    def __init__(self):
        ...
        # Ukuran canvas dibuat tetap seperti kertas di Microsoft Paint
    ...
    def paintEvent(self, event):
        ...
        if self.current_tool == Tool.LINE:
            ...
            pts = [
                QPoint(
                    int(cx + r * math.cos(math.radians(i * 72 - 90))),
                    int(cy + r * math.sin(math.radians(i * 72 - 90))),
                )
                for i in range(5)
            ]
            ...
            pts = [
                QPoint(
                    int(cx + r * math.cos(math.radians(i * 60))),
                    int(cy + r * math.sin(math.radians(i * 60))),
                )
                for i in range(6)
            ]
            painter.drawPolygon(QPolygon(pts))
    ...
    def _paint_animated_selection(self, painter: QPainter):
        ...
        if self.anim_mode == "bounce":
            ...
            phase = abs(math.sin(math.radians(t * 2)))
            scale_y = 1.0 - 0.12 * phase
            scale_x = 1.0 + 0.08 * phase
